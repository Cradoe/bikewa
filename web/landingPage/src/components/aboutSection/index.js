...
import { appMockupTwo, assetSeven } from "../../shared/generalAssests";

const Aboutsection = () => {
    return (
        <section id="about-area" className="bg-3">
            <div className="about-area-circle">
                <img className="circle1" src={assetSeven} alt="" />
                <img className="circle2" src={assetSeven} alt="" />
            </div>
            ...
            <div className="about-app-mocup">
                <img src={appMockupTwo} className="img-fluid" alt="" />
            </div>
